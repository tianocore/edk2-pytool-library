...
hamburger = bytes.fromhex(
    (
        "424d3603000000000000360000002800000010000000100000"
...
hamburger_lores = bytes.fromhex(
    "424df60000000000000076000000280000001000000010"
...
bad_header_burger = bytes.fromhex(
    "434df600000000000000760000002800000010000000"
