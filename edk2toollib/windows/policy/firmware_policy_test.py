...
class FirmwarePolicyTest(unittest.TestCase):
    ...
    def test_basic_create_encode_decode_roundtrip(self):
        ...
        TargetInfo = {'Manufacturer': 'Contoso Computers, LLC',  # EV Certificate Subject CN="<foo>", recommend also matches SmbiosSystemManufacturer, SMBIOS Table 1, offset 04h (System Manufacturer)
                      'Product': 'Laptop Foo',                   # SmbiosSystemProductName, SMBIOS Table 1, offset 05h (System Product Name)
                      'SerialNumber': 'F0013-000243546-X02',     # SmbiosSystemSerialNumber, SMBIOS System Information (Type 1 Table) -> Serial Number
                      'OEM_01': 'ODM Foo',                       # Yours to define, or not use (NULL string), ODM name is suggested
