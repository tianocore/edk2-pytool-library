...
from edk2toollib.uefi.edk2.basetools.Common.BuildToolError import OPTION_MISSING
from edk2toollib.uefi.edk2.basetools.Common.BuildToolError import BUILD_ERROR
