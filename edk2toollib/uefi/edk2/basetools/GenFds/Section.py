...
from edk2toollib.uefi.edk2.basetools.CommonDataClass.FdfClass import SectionClassObject
from .GenFdsGlobalVariable import GenFdsGlobalVariable
import edk2toollib.uefi.edk2.basetools.Common.LongFilePathOs as os, glob
