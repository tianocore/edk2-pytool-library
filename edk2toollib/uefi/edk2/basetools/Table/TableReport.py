...
import edk2toollib.uefi.edk2.basetools.Common.LongFilePathOs as os, time
from Table.Table import Table
from edk2toollib.uefi.edk2.basetools.Common.StringUtils import ConvertToSqlString2
