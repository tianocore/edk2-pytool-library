...
class PathUtilitiesTest(unittest.TestCase):
    ...
    def test_get_relative_path_when_packages_path_list_contains_substrings_and_underscores(self):
        ''' test usage of GetEdk2RelativePathFromAbsolutePath when members of PackagePathList contain
        substrings of themselves with underscores, for example "MU" and "MU_TIANO"
